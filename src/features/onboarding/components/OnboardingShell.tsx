        ...
        <div className="mx-auto flex h-16 max-w-[1440px] items-center justify-between gap-4 px-4 sm:h-[72px] sm:px-6 lg:px-8">
          <div className="flex min-w-0 items-center gap-4">
            ...
            <div className="hidden min-w-0 sm:block" aria-live="polite">
              ...
              <p className="mt-0.5 truncate text-[10px] font-bold uppercase tracking-[0.11em] text-[#003478]">
                {applicationHeader.subtitle}
              </p>
            </div>
          </div>
                ...
                >
                  ...
                  <div className="mt-2 border-t border-slate-100 pt-2">
                    <button
                      ...
                      className="group font-medium flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left text-[13px] font-medium leading-5 text-red-600 transition hover:bg-red-50 hover:text-red-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#003478]/15"
                    >
                      <span className="grid h-8 w-8 shrink-0 place-items-center rounded-lg bg-slate-100 text-red-600 transition-colors group-hover:text-red-700">
