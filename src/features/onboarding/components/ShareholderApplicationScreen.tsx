        ...
        <div className="mx-auto flex max-w-[1440px] items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="min-w-0 text-center">
            <p className="truncate text-sm font-semibold text-slate-950">
              {getTypeLabel(subject)} shareholder application
            </p>
          ...
          <button
            type="button"
            onClick={onExit}
            aria-label="Close shareholder application"
      ...
      <div className="mx-auto max-w-[1440px] px-4 py-5 sm:px-6 sm:py-8 lg:px-8">
        ...
        <div className="mb-6 rounded-[22px] border border-[rgba(0,52,120,0.13)] bg-white p-5 shadow-sm sm:p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <span
              className={`inline-flex w-fit items-center gap-1.5 rounded-full px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.07em] ${isShareholderApplicationComplete(subject) ? "bg-emerald-50 text-emerald-700" : "bg-[#f3f6f9] text-slate-600"}`}
            >
              {isShareholderApplicationComplete(subject) ? (
        ...
        <div className="mb-6 overflow-hidden rounded-[22px] border border-slate-200 bg-white shadow-sm">
          ...
          <nav
            ...
            aria-label="Shareholder application sections"
          >
          ...
          <div className="mt-8 flex flex-col-reverse gap-3 border-t border-slate-100 pt-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            {screen === "review" ? (
              <button
                type="button"
                onClick={onBack}
                disabled={!isShareholderApplicationComplete(subject)}
  ...
  return (
    <div className="animate-[fadeUp_.25s_ease-out]">
      <ScreenHeading
        eyebrow="Related parties"
        title={title}
        description={`Add every ${title.toLowerCase().slice(0, -1)} associated with this trust shareholder.`}
      />
      <section className="mt-7 rounded-2xl border border-slate-200 bg-slate-50/60 p-5">
  ...
  return (
    <div className="animate-[fadeUp_.25s_ease-out]">
      <ScreenHeading
        ...
        description="Add a clear current selfie for the individual shareholder’s identity verification."
      />
      <div className="mt-7">
        <SelfieUpload
...
function ReviewScreen({
  ...
  return (
    <div className="animate-[fadeUp_.25s_ease-out]">
      <ScreenHeading
        eyebrow="Final check"
        title="Review this shareholder application"
        description="Confirm every relevant section before returning to the main company application."
      />
      <div className="mt-7 grid gap-3 sm:grid-cols-2">
        {reviewableSteps.map((step) => (
          <StatusCard
            key={step.id}
            label={step.label}
            complete={isScreenComplete(subject, step.id)}
            detail={
              isScreenComplete(subject, step.id)
      ...
      >
        ...
        <span className="text-sm leading-6 text-slate-700">
          ...
          <span className="mt-1 block">
            I confirm that these details are accurate and that all required
            ownership connections have been disclosed through complete 100%
            layers to the individual ultimate beneficial owner.
          </span>
        </span>
      </label>
      <div
      ...
      >
        ...
        <div>
          ...
          >
            {completed
              ? "You can now return to the shareholder list."
