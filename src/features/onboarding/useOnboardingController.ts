...
export function useOnboardingController() {
  ...
  const addTrustParty = (
    ...
    setForm((current) => {
      ...
      return {
        ...
        trust: {
          ...current.trust,
          [kind === "trustees" ? "trusteeCount" : "beneficiaryCount"]: String(
            parties.length,
          ),
        },
      };
    ...
    const countErrorKey =
      kind === "trustees" ? "trusteeCount" : "beneficiaryCount";
    setErrors((current) => ({
      ...current,
      [kind]: "",
      [countErrorKey]: "",
    ...
    setForm((current) => {
      ...
      return {
        ...
        trust: {
          ...
          defaultRecipientId:
            kind === "trustees" && current.trust.defaultRecipientId === id
              ? ""
  ...
  const handleApplicationTypeChange = (value: string) => {
    ...
    setForm((current) => ({
      ...
      company:
        nextType === current.personal.applicationType
          ? current.company
  ...
  const validateStep = (stepId: StepId) => {
    ...
    if (stepId === "beneficiaries" && !beneficiariesComplete) {
      ...
      nextErrors.beneficiaries =
        "Add at least one complete beneficiary record.";
    }
