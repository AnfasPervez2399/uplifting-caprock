...
export const usesSharedAddress = (type: ApplicationType) =>
...
export const isCompleteJointPersonal = (
...
export const requiresTwoPhotoIds = (country: string) =>
...
export const isSameUploadedFile = (
...
export const hasCompleteApplicantProof = (
  documents: ApplicantDocuments | undefined,
  country: string,
) =>
