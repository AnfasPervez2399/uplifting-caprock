...
const variants = {
  primary: 'bg-caprock text-white hover:bg-caprock-light shadow-lg shadow-caprock/20',
  ...
  outline: 'bg-transparent border border-border text-ink hover:border-caprock/40 hover:bg-caprock/5',
}
